...
# Cache directories for HuggingFace/PyTorch/Triton/Mamba/CUDA.
# Override any of these via environment variables; otherwise default to a local .cache/ dir.
os.environ["HF_HOME"] = "/path/to/cache/huggingface"
os.environ["TRITON_CACHE_DIR"] = "/path/to/cache/triton_cache"
os.environ["TORCH_HOME"] = "/path/to/cache/torch"
os.environ["TORCHVISION_CACHE"] = "/path/to/cache/torch"
os.environ['XDG_CACHE_HOME'] = "/path/to/cache"
os.environ['MAMBA_SSM_CACHE'] = "/path/to/cache/mamba_ssm_cache"
os.environ['CUDA_CACHE_PATH'] = "/path/to/cache/cuda_cache"
...
def evaluate(test_generator, action=None, return_predictions=False, use_trajectory_model=False, newmodel=None, flag=True):
    ...
    with torch.no_grad():
        if newmodel is not None:
            ...
            model_eval = newmodel
            chk_file_path = '/path/to/checkpoint/MHDPose/checkpoint/comparison_model.bin'
