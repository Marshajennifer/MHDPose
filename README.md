...
We follow the same data setup as [VideoPose3D](https://github.com/facebookresearch/VideoPose3D). Download and use the processed data provided by
[D3DP](https://github.com/paTRICK-swk/D3DP/tree/main) and place it in the `./data` directory:
...
We follow the data setup from [D3DP](https://github.com/paTRICK-swk/D3DP).
Download our processed data from [here](https://github.com/paTRICK-swk/D3DP/tree/main) and place it in the `./data` directory.
...
Checkpoints for Human3.6M and MPI-INF-3DHP can be and placed in the `./checkpoint` directory.
...
To evaluate our model on MPI-INF-3DHP dataset, you have to download MATLAB.
